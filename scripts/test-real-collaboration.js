...
async function testRealCollaboration() {
  console.log('🧪 Testing REAL collaboration flow...')
  
  const ownerEmail = "arzaanalikhan12@gmail.com"
  const collaboratorEmail = "naqvimohammedjawad@gmail.com"
  
  try {
    // Step 1: Check if projects exist for the owner
    console.log('\n1. Checking projects for owner...')
    ...
    // Step 2: Create an invitation for the collaborator
    console.log('\n2. Creating invitation for collaborator...')
    ...
    if (inviteError) {
      ...
      console.log('   This means the project_collaborators table needs to be created first.')
      return
    }
    ...
    // Step 4: Test accepting the invitation (simulate collaborator login)
    ...
    console.log('\n🎉 Real collaboration test completed!')
    console.log('\n📋 Summary:')
